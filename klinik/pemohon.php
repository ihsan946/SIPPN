                                    ...
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <?php $queryStatusKesehatan = mysqli_query($koneksi,"SELECT t_kesehatan.id_pengguna FROM t_pengguna,t_kesehatan WHERE t_kesehatan.id_pengguna = t_pengguna.id_pengguna AND t_kesehatan.id_pengguna = '$id_pengguna' ");
                                                ...
                                                ?>
                                                <td>
                                                    <span class="badge rounded-pill bg-success"><?php echo $hasil_status;?></span>
                                                    <span class="badge rounded-pill bg-success"><?php echo $hasil_skrining;?></span>
                                                </td>
                                                <td> 
                                                <div class ="d-flex justify-content-start" >
                                                    <form action="editpemohon.php" method = "post" class="mx-2">
                                                        <input type="hidden" name = "id_pengguna" value ="<?php echo $data['id_pengguna'];?>">
                                                        <button type="submit" class="btn btn-sm btn-warning">
                                                            <i class="far fa-edit"></i> Edit
                                                        </button>
                                                    </form>   
                                                    <form action="hapus_pemohon.php" method = "post" class="mx-2">
                                                        <input type="hidden" name = "id_pengguna" value = "<?php echo $data['id_pengguna'];?>" >
                                                        <button type="submit" class="btn btn-sm btn-danger"><i class="far fa-trash-alt"></i> Delete</button>
                                                    </form> 
                                                    <form action="../cetak/cetak_dokumen.php" method = "POST" class="mx-2">
                                                        <input type="hidden" name = "id_pengguna" value = "<?php echo $data['id_pengguna'];?>" >
                                                        <button type="submit" class="btn btn-sm btn-success"><i class="fas fa-print"></i> Print</button>    
                                                    </form>    
                                                </div>
                                                </td>   
                                            </tr>
