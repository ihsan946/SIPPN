        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="pemohon.php" class="nav-link <?php if ($halaman == "Data Pemohon") echo "active"; ?>">
                ...
                <li class="nav-item">
                    <a href="pemeriksaan.php" class="nav-link <?php if ($halaman == "Data Pemeriksaan") echo "active"; ?>">
                        <i class="nav-icon fas fa-users"></i>
                        <p>
                            Data Pemeriksaan
                        </p>
                ...
                <li class="nav-item">
                    <a href="testassist.php" class="nav-link <?php if ($halaman == "Test ASSIST") echo "active"; ?>">
